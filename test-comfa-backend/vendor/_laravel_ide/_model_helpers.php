...
namespace App\Models {
     ...
     * @property string $codigo_episodio
     * @property string|null $fecha_emision
     * @property string $nombre
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Personaje> $personajes
     * @property-read int|null $personajes_count
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereFechaEmision($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereCodigoEpisodio($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Episodio>|Episodio query()
     ...
     * @property string $nombre
     * @property int $id
     * @property-read \App\Models\Locacion $origen
     * @property-read \App\Models\Locacion $ubicacion
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Episodio> $episodios
     * @property-read int|null $episodios_count
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereEstado($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereEspecie($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereTipo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereGenero($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereOrigenId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereUbicacionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereImagenUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Personaje>|Personaje query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Personaje extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
